export default function MessageIcon({fill="currentColor", className=""}) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" fill={fill} height="50" width="50" viewBox="0 96 960 960" className={className}>
