      ...
      <div className="md:flex md:flex-wrap lg:flex-wrap justify-center gap-5">
        ...
        <div className="mx-5 flex flex-col">
          ...
          <div className="max-w-[375px] h-[307px] p-5 bg-[#363636] rounded-b-[30px]">
            ...
            <p className="text-center mb-3 text-lg font-light leading-6">A clone of first pages of AirBnb website consuming aPI services for geolocalization e interactive maps to exercise functionalities of Next.js and Tailwinf stylesheet framwork.</p>
        ...
        <div className="mx-5 flex flex-col mt-5 lg:mt-0">
          ...
          <div className="max-w-[375px] h-[307px] p-5 bg-[#363636] rounded-b-[30px]">
            ...
            <p className="text-center mb-3 text-lg font-light leading-6">Simple application to exercise the use of APIs e basic functionalities of Vue.js and Bulma stylesheet framework.</p>
