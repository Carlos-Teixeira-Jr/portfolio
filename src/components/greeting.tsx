    ...
    <Element name="about">
      <div className="flex justify-evenly lg:my-[90px] my-14">
        <div>
          ...
          <p className="lg:text-6xl md:text-4xl font-extrabold leading-2">{t('translation.greeting.myNameIs')}</p>
          ...
          <p className="lg:text-6xl md:text-4xl font-extrabold leading-2">{t('translation.greeting.whatIDo1')}<br/>{t('translation.greeting.whatIDo2')}<br/>{t('translation.greeting.whatIDo3')}</p>
          <p className="lg:text-6xl md:text-4xl font-extrabold leading-2">{t('translation.greeting.NiceToMeetYou')}</p>
        </div>
